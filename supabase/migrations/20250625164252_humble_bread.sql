/*
  ...
  1. Functions
    - `trigger_project_creation()` - Create chat channel on project creation
    - `trigger_task_assignment()` - Send notification on task assignment
    - `handle_new_auto_assign_task()` - Create timer for auto-assign tasks
    - `handle_new_task_application()` - Manage application buckets
    - `create_notification_for_user()` - Secure notification creation

  2. Triggers
    - Project creation triggers
    - Task assignment triggers
    - Application handling triggers
*/
