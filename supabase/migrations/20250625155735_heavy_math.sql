/*
  ...
  1. **users** - User profiles with enhanced fields
  2. **projects** - Client projects with proper constraints
  3. **tasks** - Project tasks with auto-assignment features
  4. **task_applications** - Worker applications to tasks
  5. **application_buckets** - Application management for clients
  6. **proposals** - Detailed proposals from workers
  7. **submissions** - Task submissions and outcomes
  8. **notifications** - User notifications system
  9. **chat_rooms** - Project communication channels
  10. **chat_participants** - Chat room membership
  11. **chat_messages** - Chat messages
  12. **invitations** - Direct worker invitations
  13. **favorites** - User favorites system
  14. **auto_assignment_timers** - Auto-assignment timing
...
-- Create or replace the create_notification_for_user function
